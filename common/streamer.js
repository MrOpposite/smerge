...
if(Meteor.isServer) {
	var TwitAppKeys = ServiceConfiguration.configurations.findOne({service: 'twitter'},{fields: {consumerKey: 1, secret: 1, _id: 0}});
	...
	var getUserTwitterStreamObject = function (endpoint) {
		...
		var tStream = userConnectionObjects[Meteor.userId()].twitterStream[endpoint];
